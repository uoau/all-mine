...
日时间 <AmDatePicker type="dayTime" v-model="date4" :limit="['2020-02-02 10:33:33','2020-12-12 12:23:22']" :disabled-date="disabledDate"/><br/>
...
export default {
    data(){
        return {
            ...
            date8: '',
            disabledDate: (date)=>{
                if(date > new Date('2021-02-06').getTime() &&  date < new Date('2021-02-08').getTime()){
                    return '不可以选择当前日期';
                }
                if(date > new Date('2021-02-10').getTime() &&  date < new Date('2021-02-13').getTime()){
                    return '不可以选择当前日期';
                }
